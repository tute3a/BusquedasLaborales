...
for pagina in range(115):         #Entra página por página
    if pagina > -1:             # Por si se corta en el medio
        #url = "https://www.zonajobs.com.ar/ofertas-de-empleo-argentina-pagina-" + str(pagina) + ".html?recientes=true"    # Para buscar entre todas las publicaciones
        ...
        df.to_csv(r'C:\ZonaJobs.csv', index=False, header=True)
